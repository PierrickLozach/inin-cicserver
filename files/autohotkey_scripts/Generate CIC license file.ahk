...
{
  Msgbox, Run "C:\Users\Administrator\Desktop\LicGenClient\LicGenClient.exe -hostid %clipboard% -hostname %A_ComputerName% -version 4 -fulllic 1000"
}
else
{
  Msgbox Can't reach license server. No CIC license will be generated
}
